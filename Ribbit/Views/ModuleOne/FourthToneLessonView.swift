...
struct FourthToneLessonView: View {
        ...
        VStack(spacing: 20) {
            ...
            ScrollView {
                VStack(alignment: .center, spacing: 10) {
                    ...
                    (Text("The Fourth Tone is called ") +
                     Text("sì shēng (四声) ").foregroundColor(Color(hex: "B79313")) +
                     Text(", meaning the fourth sound."))
                        .font(.system(size: 18))
                        .padding(.top, 50)
                        .foregroundColor(Color(hex: "#554C5D"))
                        .padding()
