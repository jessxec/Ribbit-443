      ...
      Lesson(
          ...
          words: [
              Word(
                  ...
                  starValue: 5,
                  replayAllowed: true,
                  samplePitchVectors: [146.8, 145.0, 145.6, 146.7, 147.9, 149.5, 151.5, 153.4, 155.4, 156.7, 157.7, 158.5, 158.8, 159.1, 159.0, 158.7, 158.4, 158.0, 157.4, 156.5, 155.1, 153.4, 151.9, 150.0, 147.2, 147.2, 138.6, 130.6, 123.1, 116.2, 109.7, 103.6, 98.0, 92.7, 87.8],
                  userPitchVectors: []
              ),
              Word(
                  id: "word2",
